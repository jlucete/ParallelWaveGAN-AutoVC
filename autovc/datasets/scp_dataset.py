...
class AudioMelSCPDataset(Dataset):
    ...
    def __init__(self,
        ...
        Args:
            ...
            spkemb_scp (str): Kaldi-style spkemb.scp file
        ...
        spkemb_loader = _get_feats_scp_loader(spkemb_scp)
        audio_keys = list(audio_loader.keys())
        mel_keys = list(mel_loader.keys())
        spkemb_keys = list(spkemb_loader.keys())
        ...
        if audio_length_threshold is not None:
            ...
            spkemb_keys = [spkemb_keys[idx] for idx in idxs]
        ...
        assert len(audio_keys) == len(spkemb_keys), \
            f"Number of audio and spkemb files are different ({len(audio_keys)} vs {len(spkemb_keys)})."

        self.audio_loader = audio_loader
        self.mel_loader = mel_loader
        self.spkemb_loader = spkemb_loader
    ...
    def __getitem__(self, idx):
        ...
        spkemb = self.spkemb_loader[utt_id]
